    ...
    <div class="content">
        ...
        <div class="spm" >
            ...
            <?php 
             ...
             ?>
        <div class="sp1">
            <a href="sanpham_ct.php?ma=<?php echo $value['idsp'] ?>"><img src="admin/images/<?php echo $value['anhsp'] ?>" width="200px" height="200px"></a>
            <div></div><br>
            <a href="sanpham_ct.php?ma=<?php echo $value['idsp'] ?>"><b ><?php echo $value['tensp'] ?></b></a>
