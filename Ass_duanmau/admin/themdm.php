...
<head>
    <meta charset="utf-8">
    <title>Tin tức</title>
    <link rel="stylesheet" type="text/css" href="cs/themnd.css">
</head>
<body>
    <div class="main">
    <div class="head-link">
    ...
    <div class="content">
        ...
        <h2 style="color: #CDAD00"> &nbsp&nbsp&nbspTHÊM DANH MỤC</h2><br>
      	<input type="hidden" name="iddm"><br>
        Tên danh  mục: &nbsp <input type="text" name="tendm" style="width: 300px; height: 30px;" required=""><br><br>
    ...
    if(isset($_POST['luu'])){
        ...
        $sql="insert into danhmuc values('$iddm','$tendm')";
        $kq=$conn->exec($sql);
        if($kq==1){
