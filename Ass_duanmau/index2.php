    ...
    <div class="content">
        ...
        <div class="spm" >
            ...
            <?php 
             ...
             ?>
        <div class="sp1">
            <a href="sanpham_ct2.php?ma=<?php echo $value['idsp'] ?>"><img src="admin/images/<?php echo $value['anhsp'] ?>" width="200px" height="200px"></a>
            <div></div><br>
            <a href="sanpham_ct2.php?ma=<?php echo $value['idsp'] ?>"><b ><?php echo $value['tensp'] ?></b></a>
            <p>KM: <?php echo $value['giakm'] ?> VNĐ</p>
            <del>Giá: <?php echo $value['giasp'] ?> VNĐ</del>
            <a href="sanpham_ct2.php?ma=<?php echo $value['idsp'] ?>"><button type="submit">Mua ngay</button></a>
        </div>
